...
SELECT 
    ...
    c.[Password],                       
    NULL AS SecurityQuestion,           -- ainda n�o temos, fica NULL
    NULL AS SecurityAnswer,             -- ainda n�o temos, fica NULL
    c.DateFirstPurchase                 
...
SELECT 
    u.UserKey,
    u.Email,
    CONCAT('Ol� ', c.FirstName, ', obrigado por se registar!') AS Message,
